...
// let fullscreen = document.querySelector(".modal-overlay");
// let fullscreen1 = document.querySelector(".modal-dialog1");
//   let wrapper = document.querySelector(".help");
...
//     $(".modal-dialog1").removeClass("open");
//   });
